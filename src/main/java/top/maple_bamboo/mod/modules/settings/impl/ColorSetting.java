package top.maple_bamboo.mod.modules.settings.impl;
...
import top.maple_bamboo.mod.modules.impl.client.Colors;
...
public class ColorSetting extends Setting {
	...
	public void loadSetting() {
		this.value = new Color(MapleClientMain.CONFIG.getInt(this.getLine(), defaultValue.getRGB()), true);
		this.isRainbow = MapleClientMain.CONFIG.getBoolean(this.getLine() + "Rainbow");
		if (injectBoolean) {
			this.booleanValue = MapleClientMain.CONFIG.getBoolean(this.getLine() + "Boolean", defaultBooleanValue);
		}
	}
}
