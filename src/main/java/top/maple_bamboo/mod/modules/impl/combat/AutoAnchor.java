...
import top.maple_bamboo.api.utils.math.AnimateUtil;
...
import static top.maple_bamboo.api.utils.world.BlockUtil.*;
...
public class AutoAnchor extends Module {
	...
	public AutoAnchor() {
		...
		setChinese("自动重生锚");
		INSTANCE = this;
		MapleClientMain.EVENT_BUS.subscribe(new AnchorRender());
	}
	...
	public void onUpdate() {
		...
		if (currentPos != null) {
			...
			boolean shouldSpam = this.spam.getValue() && (!mineSpam.getValue() || MapleClientMain.BREAK.isMining(currentPos, false));
			if (shouldSpam) {
