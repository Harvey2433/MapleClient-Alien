...
public class HoleSnap extends Module {
   ...
   private final SliderSetting priority = add(new SliderSetting("Priority", 10,0 ,100, grim::getValue));
    ...
    public void onEnable() {
        ...
        resetMove = false;
        holePos = MapleClientMain.HOLE.getHole((float) range.getValue(), true, any.getValue(), up.getValue());
    }
    ...
    public void onUpdate() {
        ...
        if (MapleClientMain.HOLE.isDoubleHole(holePos)) {
            Direction facing = MapleClientMain.HOLE.is3Block(holePos);
            if (facing != null) {
