...
public class AutoHoleFill extends Module {
    ...
    public void onUpdate() {
        ...
        CombatUtil.getEnemies(enemyRange.getValue()).stream()
                ...
                .filter(pos -> pos.toCenterPos().distanceTo(mc.player.getPos()) > selfRange.getValue() && (MapleClientMain.HOLE.isHole(pos, true, true, false) || MapleClientMain.HOLE.isDoubleHole(pos)))
                .distinct()
