...
import top.maple_bamboo.mod.modules.impl.combat.KillAura;
import top.maple_bamboo.mod.modules.impl.player.PacketEat;
...
public class AutoDupe extends Module {
            ...
            case Xin -> {
                ...
                switch (stage) {
                    ...
                    case Summon -> {
                        ...
                        InventoryUtil.inventorySwap(slot, mc.player.getInventory().selectedSlot);
                        MapleClientMain.ROTATION.snapAt(MapleClientMain.ROTATION.lastYaw, 89);
                    ...
                    case Tame -> {
                        ...
                        if (mc.player.hasVehicle()) {
                            ...
                            if (llama.isBaby()) {
                                ...
                                InventoryUtil.inventorySwap(slot, mc.player.getInventory().selectedSlot);
                                MapleClientMain.ROTATION.lookAt(llama.getPos());
                    ...
                    case Kill -> {
                        ...
                        if (check()) {
                            MapleClientMain.ROTATION.lookAt(llama.getEyePos());
    ...
    private void closeTo(BlockPos pos) {
        ...
        float forward = 1f;
        float side = 0;
        float yaw = MapleClientMain.ROTATION.getRotation(pos.toCenterPos())[0];
