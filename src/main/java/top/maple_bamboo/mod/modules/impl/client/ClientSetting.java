...
public class ClientSetting extends Module {
    ...
    public final StringSetting windowTitle = add(new StringSetting("WindowTitle", MapleClientMain.NAME + " " + MapleClientMain.VERSION, () -> page.is(Page.Misc)));
    ...
    public final StringSetting hackName = add(new StringSetting("Notification", "[" + MapleClientMain.NAME + "]", () -> page.getValue() == Page.Notification));
