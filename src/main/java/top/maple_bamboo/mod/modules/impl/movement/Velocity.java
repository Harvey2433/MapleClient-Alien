...
import top.maple_bamboo.asm.accessors.IEntityVelocityUpdateS2CPacket;
import top.maple_bamboo.asm.accessors.IExplosionS2CPacket;
...
public class Velocity extends Module {
	...
	public void onVelocity(EntityVelocityUpdateEvent event) {
		...
		if (mode.is(Mode.Grim) || mode.is(Mode.Wall)) {
			...
			boolean insideBlock = MapleClientMain.PLAYER.insideBlock;
	...
	public void onUpdate() {
		...
		if (flag) {
			if (lagBackTimer.passed(100) && (flagInWall.getValue() || !MapleClientMain.PLAYER.insideBlock)) {
