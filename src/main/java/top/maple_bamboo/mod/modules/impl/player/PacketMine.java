...
import top.maple_bamboo.api.events.impl.ClickBlockEvent;
...
import top.maple_bamboo.asm.accessors.IPlayerMoveC2SPacket;
...
import top.maple_bamboo.mod.modules.impl.combat.AutoAnchor;
import top.maple_bamboo.mod.modules.impl.combat.AutoCev;
import top.maple_bamboo.mod.modules.impl.combat.AutoCrystal;
...
public class PacketMine extends Module {
	...
	public float getDigSpeed(BlockState state, ItemStack itemStack) {
		...
		boolean inWeb = MapleClientMain.PLAYER.isInWeb(mc.player) && mc.world.getBlockState(breakPos).getBlock() == Blocks.COBWEB;
