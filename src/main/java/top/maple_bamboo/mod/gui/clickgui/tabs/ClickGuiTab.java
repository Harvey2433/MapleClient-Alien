package top.maple_bamboo.mod.gui.clickgui.tabs;
...
import top.maple_bamboo.mod.gui.clickgui.components.impl.ModuleComponent;
...
public class ClickGuiTab extends Tab {
	...
	public ClickGuiTab(String title, int x, int y) {
		this.title = title;
		this.x = MapleClientMain.CONFIG.getInt(title + "_x", x);
		this.y = MapleClientMain.CONFIG.getInt(title + "_y", y);
		this.width = 98;
