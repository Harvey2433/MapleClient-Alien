package top.maple_bamboo.mod.gui.elements;
...
import top.maple_bamboo.mod.gui.clickgui.tabs.Tab;
...
public class ArmorHUD extends Tab {
	...
	public ArmorHUD() {
		this.width = 80;
		this.height = 34;
		this.x = (int) MapleClientMain.CONFIG.getFloat("armor_x", 0);
		this.y = (int) MapleClientMain.CONFIG.getFloat("armor_y", 200);
	}
