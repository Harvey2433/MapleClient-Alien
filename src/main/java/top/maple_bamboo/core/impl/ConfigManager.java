...
import top.maple_bamboo.mod.modules.impl.client.HUD;
import top.maple_bamboo.mod.modules.impl.client.ModuleList;
import top.maple_bamboo.mod.modules.settings.Setting;
...
public class ConfigManager extends Manager {
	...
	public static void resetModule() {
		for (Module module : MapleClientMain.MODULE.modules) {
	...
	public void loadSettings() {
		for (Module module : MapleClientMain.MODULE.modules) {
			...
			module.setState(MapleClientMain.CONFIG.getBoolean(module.getName() + "_state", module instanceof HUD || module instanceof ModuleList));
		}
	}
	public void saveSettings() {
		...
		try {
			...
			printwriter.println("prefix:" + MapleClientMain.PREFIX);

			for (ClickGuiTab tab : MapleClientMain.GUI.tabs) {
				printwriter.println(tab.getTitle() + "_x:" + tab.getX());
				printwriter.println(tab.getTitle() + "_y:" + tab.getY());
			}
			printwriter.println("armor_x:" + MapleClientMain.GUI.armorHud.getX());
			printwriter.println("armor_y:" + MapleClientMain.GUI.armorHud.getY());
			...
			System.out.println("[" + MapleClientMain.NAME + "] Failed to save settings");
		} finally {
	...
	public void readSettings() {
		...
		try {
			...
			System.out.println("[" + MapleClientMain.NAME + "] Failed to load settings");
		}
	}
