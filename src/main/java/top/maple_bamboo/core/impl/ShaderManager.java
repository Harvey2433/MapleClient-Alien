...
import top.maple_bamboo.api.interfaces.IShaderEffect;
...
public class ShaderManager implements Wrapper {
    ...
    public void setupShader(Shader shader, ManagedShaderEffect effect) {
        top.maple_bamboo.mod.modules.impl.render.Shader shaderChams = top.maple_bamboo.mod.modules.impl.render.Shader.INSTANCE;
