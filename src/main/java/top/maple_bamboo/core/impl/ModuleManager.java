...
import top.maple_bamboo.mod.Mod;
import top.maple_bamboo.mod.gui.clickgui.ClickGuiScreen;
import top.maple_bamboo.mod.modules.Module;
import top.maple_bamboo.mod.modules.impl.client.*;
import top.maple_bamboo.mod.modules.impl.combat.*;
import top.maple_bamboo.mod.modules.impl.exploit.*;
import top.maple_bamboo.mod.modules.impl.misc.*;
import top.maple_bamboo.mod.modules.impl.movement.*;
import top.maple_bamboo.mod.modules.impl.player.*;
import top.maple_bamboo.mod.modules.impl.client.*;
import top.maple_bamboo.mod.modules.impl.combat.*;
import top.maple_bamboo.mod.modules.impl.exploit.*;
import top.maple_bamboo.mod.modules.impl.misc.*;
import top.maple_bamboo.mod.modules.impl.movement.*;
import top.maple_bamboo.mod.modules.impl.player.*;
import top.maple_bamboo.mod.modules.impl.player.freelook.FreeLook;
import top.maple_bamboo.mod.modules.impl.render.*;
import top.maple_bamboo.mod.modules.impl.render.*;
import top.maple_bamboo.mod.modules.settings.Setting;
import top.maple_bamboo.mod.modules.settings.impl.BindSetting;
...
public class ModuleManager implements Wrapper {
    ...
    public void render3D(MatrixStack matrixStack) {
        ...
        MapleClientMain.EVENT_BUS.post(new Render3DEvent(matrixStack, mc.getTickDelta()));
        matrixStack.pop();
