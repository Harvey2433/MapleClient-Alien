package top.maple_bamboo;

import top.maple_bamboo.api.events.eventbus.EventBus;
import top.maple_bamboo.core.impl.*;
...
public final class MapleClientMain implements ModInitializer {
    ...
    public static final String NAME = "Maple Client";
    ...
    public static void load() {
        ...
        PREFIX = MapleClientMain.CONFIG.getString("prefix", ";");
        ...
        CONFIG.loadSettings();
        System.out.println("[" + MapleClientMain.NAME + "] loaded");
    ...
    public static void unload() {
        loaded = false;
        System.out.println("[" + MapleClientMain.NAME + "] Unloading..");
        EVENT_BUS.listenerMap.clear();
        ConfigManager.resetModule();
        System.out.println("[" + MapleClientMain.NAME + "] Unloaded");
    }

    public static void save() {
        System.out.println("[" + MapleClientMain.NAME + "] Saving");
        CONFIG.saveSettings();
        FRIEND.save();
        XRAY.save();
        TRADE.save();
        System.out.println("[" + MapleClientMain.NAME + "] Saved");
    }
}
