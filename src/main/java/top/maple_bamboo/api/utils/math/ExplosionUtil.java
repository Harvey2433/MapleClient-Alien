package top.maple_bamboo.api.utils.math;

import top.maple_bamboo.MapleClientMain;
import top.maple_bamboo.core.impl.PlayerManager;
...
public class ExplosionUtil implements Wrapper {
    ...
    public static float getBlastReduction(LivingEntity entity, float damageI) {
        ...
        if (entity instanceof PlayerEntity player) {
            PlayerManager.EntityAttribute a = MapleClientMain.PLAYER.map.get(player);
            if (a == null) return 0;
